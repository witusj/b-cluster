...
cat("De vector t4 bevat de uitkomsten van de test 'G komt voor in H':", t4, "en I bevat dus", length(L), "elementen.")
```
...
De **vereniging** van twee verzamelingen J en K, $\cup$, is de verzameling waarvan de elementen tot A of tot B of tot beide behoren.

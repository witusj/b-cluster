...
De verzameling $\mathbb{R}$ (reële getallen) bevat alle rationale en irrationale getallen. $\mathbb{C}$ is de verzameling van alle complexe getallen (het is op dit moment voldoende om te weten dat het hier gaat om combinaties van alle reële getallen en met het imaginaire getal $\sqrt{-1}$). Er geldt dus:

$\mathbb{N} \subset \mathbb{Z} \subset \mathbb{Q} \subset \mathbb{R} \subset \mathbb{C}$

<hr>
<h4>Toepassing verzamelingsleer op kansberekening</4>

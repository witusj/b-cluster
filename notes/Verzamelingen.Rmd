...
In R (of iedere andere programmeertaal) kunnen we geen oneindige verzamelingen maken, zoals bijvoorbeeld **de verzameling $\mathbb{N}$ van positieve gehele getallen en het getal 0**:
